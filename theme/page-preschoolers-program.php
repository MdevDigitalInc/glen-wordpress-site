  ...
  <section class="glen-preschoolers-hero">
    ...
    <div class="glen-hero-content --sticker">
      <div class="glen-hero-sticker">
        ...
        <p>Our exceptional outdoor program includes a play yard with a sand area shaded by a large maple tree. In the summer, we have a special outdoor program to take advantage of the beautiful weather with lots of fun games, activities and exploration. We pull out our pools for splashing and dig for treasures in our sand area that is shaded by a large sugar maple. Our unique and challenging climber and the large paved bike path also offers many hours of fun large-motor play.</p>
        ...
        <a class="glen-btn --solid-gw" title="Join our waiting list" href="https://london.onehsn.com/">join our waiting list</a>
      </div>
    </div>
  </section>
