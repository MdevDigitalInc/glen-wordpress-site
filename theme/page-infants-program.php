...
<div class="glen-infants-page">
  ...
  <section class="glen-infants-hero">
    ...
    <div class="glen-hero-content --sticker">
      <div class="glen-hero-sticker">
        <h1>Infants</h1>
        <p>Welcome Babies! Our priority is getting to know you and your baby and developing meaningful relationships. Our Infant team is made up of kind, nurturing caregivers who have the skills and experience to ensure our babies thrive!  For a smooth transition into care, your baby will be on their own feeding and sleep routine, so we can follow their lead and respond with sensitivity to their signals. Our Educators implement a curriculum that emerges from the interests of the infants and encourages play, curiosity and optimal growth in all areas of development. And of course, hugs and cuddles are always on the agenda!</p>
        <div class="glen-iconstrip">
          <div class="glen-iconstrip-bar"></div>
          <img class="glen-iconstrip-image" src="<?php bloginfo('template_url'); ?>/img/icons/icon-bear.svg" alt="Image of red teddy bear" />
          <div class="glen-iconstrip-bar"></div>
        </div>
  ...
  <section class="glen-infants-balcony mdev-todo">
